...
public class DummyObject {
    ...
    protected Account newMockAccount(Long id, Long number, BigDecimal balance, User user) {
        String encodedPw = passwordEncoder.encode("1234");
    ...
    protected Transaction newMockDepositTransaction(Long id, Account account){
        account.deposit(BigDecimal.valueOf(10.0));
    ...
    protected Transaction newTransferTransaction(Account withdrawAccount, Account depositAccount,
        ...
        withdrawAccount.withdraw(BigDecimal.valueOf(10.0));
        depositAccount.deposit(BigDecimal.valueOf(10.0));
